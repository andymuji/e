...
class SafetyController:
    """Convert sensor state into a bounded motion decision."""

    def __init__(self, stop_distance: float = 0.35, caution_distance: float = 0.8):
        if stop_distance <= 0:
    ...
    def evaluate(self, nearest_obstacle_distance: float | None) -> SafetyDecision:
